...
public class MinioTest {
    ...
    void testUpload2() throws Exception {
        FileInputStream stream = new FileInputStream("C:\\Users\\lgy\\Desktop\\邱.jpg");
    ...
    void testUpload() {
        try {
            ...
            //http://192.168.2.100:9000/gmall/1.jpg
            System.out.println("上传成功：访问地址：http://192.168.2.100:9000/gmall/123.jpg");
        } catch (Exception e) {
